                            ...
                            <tr className="border-2 border-gray-300">
                                ...
                                <td className="border-2 border-gray-300 h-14">
                                    <div className="flex flex-row border-2 rounded-lg border-gray-300 w-20 overflow-hidden m-auto">
                                        <button onClick={showEditModal} className="w-10 h-8 border-r-2 border-gray-300 hover:bg-slate-300">Edit</button>
                                ...
                                <Edit_Modal itemid={x.id} id="modal_edit_user"></Edit_Modal>
                            </tr>
                        )
                    }
                    )
